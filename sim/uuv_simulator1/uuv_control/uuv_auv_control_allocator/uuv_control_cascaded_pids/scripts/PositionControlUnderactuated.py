...
class PositionControllerNode:
    def __init__(self):
        ...
        self.pub_cmd_vel = rospy.Publisher('/microfred_position_control/cmd_vel', geometry_msgs.Twist, queue_size=10)
    ...
    def odometry_callback(self, msg):
        ...
        self.pub_cmd_vel.publish(/microfred_position_control/cmd_vel)
